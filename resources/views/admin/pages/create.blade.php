    ...
    <div class="app-content my-3 my-md-5">
        <div class="side-app">
            <div class="page-header">
                <h4 class="page-title">إضافه صفحه جديده</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">الصفحات</a></li>
                    <li class="breadcrumb-item active" aria-current="page">إضافه صفحه جديده</li>
                </ol>
            </div>
            <!--/Page-Header-->
                ...
                <div class="container col-xl-12">
                    <div class="card m-b-20">
                        <div class="card-header">
                            <h3 class="card-title">إضافه صفحه</h3>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{route("admin.pages.store")}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputname"  placeholder="عنوان الصفحه" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="exampleInputEmail1">عنوان الصفحه بالعربى</label>
                                    <input type="text" name="title_ar" class="form-control" id="exampleInputEmail2" placeholder="عنوان الصفحه بالعربى" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="exampleInputPassword1">مسار الصفحه</label>
                                    <input type="text" name="slug" class="form-control" id="exampleInputPassword2" placeholder="مسار الصفحه" required>
                                </div>
                                ...
                                <div class="row row-cards">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <textarea class="content2" name="description_ar" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="keywords" rows="4" placeholder="الكلمات الدلاليه" required></textarea>
                                </div>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input class="form-control" id="colorpicker" name="background_color" type="color" required>
                                      </div>
                                  </div>
