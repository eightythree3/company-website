...
<head>
    ...
    <title>EightyyThree Login Panel</title>
...
<div class="preloader">
    <div class="loader">
        ...
        <p class="loader__label">83 ADMIN PANEL LOADING</p>
    </div>
</div>
<!-- ============================================================== -->
...
<section id="wrapper" class="login-register login-sidebar" style="background-image:url({{ url('') }}/assets/images/background/login-register.jpg);">
    <div class="login-box card">
        <div class="card-body">
            <form method="post" action="{{ url('/admin/login') }}"  class="form-horizontal form-material" id="loginform">
                {!! csrf_field() !!}
                <a href="javascript:void(0)" class="text-center db"><img src="{{ url('/img/logo_2.png') }}" alt="Home" /><br/>
                </a>
